...
public class student {
 ...
 //       panel1.setLayout(new FlowLayout());
        ...
        JRadioButton assign = new JRadioButton("View Attendence",true);
        JRadioButton test = new JRadioButton("View Marks");
...
//        panel2.add(panel22);
        ...
        panel4.setBorder(new EmptyBorder(30, 10, 10, 10));
        JButton button_attend=new JButton("View Attendence");
        button_attend.setBounds(100,100,100,100);
        button_attend.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Table ob=new Table(subtext.getText()+"_attend",rollno,3);
            }
        });
        panel4.add(button_attend);
        JButton button_test=new JButton("View Marks");
        button_test.setBounds(100,100,100,100);
        button_test.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Table ob=new Table(subtext2.getText()+"_test",rollno,4);
            }
        });
